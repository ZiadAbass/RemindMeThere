...
- (void)setupTitle {
    ...
    if (pTitle) {
        if (!titleLabel) {
            ...
            [titleLabel setFont:[UIFont fontWithName:@"Futura" size:kPopupTitleFontSize]];
...
- (void)setupSubtitle {
    ...
    if (pSubTitle) {
        ...
        if (!subTitleLabel) {
            ...
            [subTitleLabel setFont:[UIFont fontWithName:@"Optima" size:kPopupSubTitleFontSize]];
...
- (void)setupButtons {
    ...
    if (pCancelTitle) {
        ...
        if (!cancelBtn) {
            ...
            [cancelBtn.titleLabel setFont:[UIFont fontWithName:@"Optima" size:16.0]];
    ...
    if (pSuccessTitle) {
        ...
        if (!successBtn) {
            ...
            [successBtn.titleLabel setFont:[UIFont fontWithName:@"Optima" size:16.0]];
...
- (UITextField *)textFieldWithPlaceholder:(NSString *)placeholderText numberOfField:(int)num {
    ...
    [textField setFont:[UIFont fontWithName:@"Optima" size:14.0f]];
